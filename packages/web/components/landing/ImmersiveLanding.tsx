...
const FILM_CHAPTERS = [
  ...
  },
  {
    ...
    body: "Move between WETH and FLX, provide focused liquidity, then put the LP position back to work—all from one wallet.",
    align: "right",
    accent: "To the moon.",
  },
] as const;
...
const ROUTES = [
  ...
  },
  {
    ...
    copy: "Enter the MasterChef route where newly minted FLX follows your share of the pool.",
    input: "WETH",
    output: "FLX",
    href: "/farm",
  },
  {
    ...
    copy: "Pair WETH with FLX, collect swap fees, and stake the resulting LP position.",
    input: "WETH + FLX",
    output: "LP + FLX",
    href: "/pool",
  },
