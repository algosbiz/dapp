 ...
 * deployer wallet, same as the FLX pre-mint — see HANDOFF.md.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="rounded-card bg-canvas p-6 shadow-card sm:p-8">
          <h2 className="font-display text-lg font-extrabold tracking-tight text-ink">Stake (WETH → tFLX)</h2>
          ...
          <div className="mt-4 rounded-control bg-canvas-soft p-4">
            ...
            <p className="text-xs text-ink-body">tFLX / sec</p>
          </div>
          <p
