 ...
 * else (APR, the WETH-FLEX market cap, the tokenomics calculator) deliberately avoids needing
 ...
 * USD if FLX traded at today's real ETH price?" — the ETH/USD leg is real, the FLX/WETH leg
